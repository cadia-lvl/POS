...
def get_adjusted_lengths(
    ...
    encodings = [
        tokenizer.encode_plus(sentence, is_split_into_words=True, return_offsets_mapping=True) for sentence in sentences
    ]
...
def chunk_dataset(ds: FieldedDataset, tokenizer: PreTrainedTokenizer, max_sequence_length) -> FieldedDataset:
